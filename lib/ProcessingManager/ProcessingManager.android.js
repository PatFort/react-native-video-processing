...
import type { sourceType, trimOptions, previewMaxSize, format, cropOptions } from "./types"
...
export class ProcessingManager {
  ...
  static getPreviewForSecond(
    ...
    return TrimmerManager.getPreviewImageAtPosition(mData).then(res => res.image)
  }
